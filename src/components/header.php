                                        ...
                                        <div id="auth-form" class="space-y-4">
                                            ...
                                            <form id="login-form" action="login.php" method="POST">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter your username" required />
                                                </div>
                                                <div class="mb-4">
                                                ...
                                                <div class="text-sm font-medium text-gray-500 dark:text-gray-300 mt-4">
                                                    Not registered? <a href="#" id="switch-to-verify" class="text-blue-700 hover:underline dark:text-blue-500">Create account</a>
                                                </div>
                                            </form>

                                            <!-- Verify Form -->
                                            <form id="verify-form" class="hidden space-y-4" method="POST" action="check_student_id.php">
                                                <div>
                                                    <label for="student_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Student ID</label>
                                                    <input type="text" name="student_id" id="student_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter your ID" required />
                                                </div>
                                                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                                   
                                                    <!-- <button type="submit" name="submit" id="switch-to-register" class="bg-blue-700 text-white hover:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-600 font-medium rounded-lg text-sm px-4 py-2">Check ID</button> -->
                                                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Check ID</button>
                                                </div>
                                            ...
                                            <!-- Registration Form -->
                                            <form id="register-form" class="hidden space-y-4" action="#">
                                                <div>
                                                    <label for="reg-email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
                                                    <input type="email" name="reg-email" id="reg-email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required />
                                                </div>
                                                <div>
                                                    <label for="reg-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your password</label>
                                                    <input type="password" name="reg-password" id="reg-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                                                </div>
                                                <div>
                                                ...
                                                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                                    Already registered? <a href="#" id="switch-to-login" class="text-blue-700 hover:underline dark:text-blue-500">Login here</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
