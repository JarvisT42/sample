        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <div id="auth-form" class="space-y-4">
                    ...
                    <!-- Verify Form -->
                    <form id="verify-form" class="hidden space-y-4" action="#" onsubmit="checkStudentId(event)">
                        <div>
                        ...
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                            <button id="switch-to-register" class="bg-blue-700 text-white hover:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-600 font-medium rounded-lg text-sm px-4 py-2">Check ID</button>
                        </div>
                    </form>
