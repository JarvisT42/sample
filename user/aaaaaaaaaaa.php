                        ...
                        <div class="scrollable-table-container border border-gray-200 dark:border-gray-700">
                            <div class="container mx-auto px-4 py-6">
                                ...
                                <ul id="tableData" class="flex flex-col space-y-4">
                                    <li class="w-full bg-white shadow-md rounded-lg overflow-hidden">
                                        <div class="p-6 border border-gray-200 dark:border-gray-700">
                                            <div class="flex flex-col md:flex-row items-start">
                                                <!-- Number Indicator -->
                                                <div class="flex-none w-8 mr-4 text-gray-500 font-bold">
                                                    1
                                                </div>
                                                <!-- Book Information Section -->
                                                <div class="flex-grow border-l pl-4">
                                                    <div class="flex justify-between items-start mb-2 flex-col md:flex-row">
                                                        <div class="mb-2 md:mb-0">
                                                            ...
                                                            <p class="text-sm text-gray-500"> Published: 2023-01-01 | Copies: 3</p>
                                                        </div>
                                                        <button class="bg-green-500 text-white px-3 py-1 rounded text-sm">Add to Book Bag</button>
                                                    </div>
                                                    <!-- Additional Book Info -->
                                                    <div class="mt-2">
                                                        <p class="text-gray-600">Additional Info Line 1</p>
                                                        <p class="text-sm text-gray-500">Published: 2023-01-01 | Copies: 3</p>
                                                    </div>
                                                    <div class="mt-2">
                                                        <p class="text-gray-600">Additional Info Line 2</p>
                                                        <p class="text-sm text-gray-500">Published: 2023-01-01 | Copies: 3</p>
                                                    </div>
                                                    <button class="mt-4 bg-blue-500 text-white px-3 py-1 rounded text-sm">Table Information</button>
                                                </div>
                                                <!-- Book Cover Image Section -->
                                                <div class="flex-none ml-4">
                                                    <img src="book-cover-placeholder.jpg" alt="Book Cover" class="w-40 h-56 border-2 border-gray-400 rounded-lg object-cover">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- Repeat the <li> structure for more items as needed -->
                                </ul>
